...
public class StudentController {
    ...
    public String goStudentList(Model model,
                                ...
                                @RequestParam Optional<String> keyword ,@ModelAttribute User user,HttpServletResponse response) {
...
//        model.addAttribute("user", user);
    ...
    public String goDetailStudent(@RequestParam Integer id, Model model, HttpServletResponse response, @ModelAttribute User user) throws Exception {
        Cookie cookieUsername = new Cookie("userNameCookie", user.getUsername());
